...
def EI_phase_coeff():
    ...
    #EARLY INSPIRAL Phase Coefficients >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
class TaylorF2_PPE(Waveform):
    ...
    def calculate_phase(self): 
        ...
        phi_0, phi_1, phi_2, phi_3, phi_4, phi_5, phi_5_l, phi_6, phi_6_l, phi_7 = EI_phase_coeff()
...
class IMRPhenomD_PPE(Waveform):
    ...
    def calculate_phase(self): 
        ...
        sigma2, sigma3, sigma4 = LI_phase_coeff()
        ...
        ####################### IN-MERG PHASE CONTINUITY CONDITIONS ###################
         ...
         alpha2, alpha3, alpha4, alpha5 = MR_phase_coeff()
